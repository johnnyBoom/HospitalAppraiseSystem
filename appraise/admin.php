...
<head>
    ...
    <style>
        ...
        .wrap #top-nav .noDecorate:hover,.wrap #top-nav .noDecorate:focus{
            color: #777;
        }
        .wrap #top-nav .noDecorate {
            cursor: default;
        }
        .glyphicon-user {
            font-size: 16px;
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="top-nav">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">用户维护<span class="sr-only">(current)</span></a></li>
                    <li><a href="#">科室维护</a></li>
                    <li><a href="#">评价范围维护</a></li>
                    <li><a href="#">注册用户审核</a></li>
                </ul>
